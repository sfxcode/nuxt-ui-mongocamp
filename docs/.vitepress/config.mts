      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Server Proxy Auth', link: '/guide/server-proxy-auth' },
          ],
        },
      ],
      '/components/': [
        {
          ...
          items: [
            ...
            { text: 'MongocampBucketFiles', link: '/components/mongocamp-bucket-files' },
      ...
      '/composables/': [
        {
          ...
          items: [
            ...
            { text: 'useMongocampClientApi', link: '/composables/use-mongocamp-client-api' },
            { text: 'useMongocampProxyApi', link: '/composables/use-mongocamp-proxy-api' },
          ],
        },
      ],
    },
